...
import { AppBar, Button, Collapse, Box, CssBaseline, IconButton, ThemeProvider, Toolbar, Typography } from "@mui/material";
    ...
    <ThemeProvider theme={theme}>
      ...
      <Box sx={{height: '100vh', display: 'flex', flexDirection: 'column'}}>
        <AppBar position="relative">
          <Toolbar>
            <IconButton color="inherit" sx={{mr: 4}} onClick={() => setOpen(!open)}>
              <MenuIcon/>
            </IconButton>
            <Typography variant="h6" sx={{flexGrow: 1}}>Kitchen</Typography>
            ...
            : <Button variant="outlined" color="inherit" onClick={() => navigate('/login')}>Log in</Button>)}
          </Toolbar>
        </AppBar>
