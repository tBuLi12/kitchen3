...
function getNavButton(link: NavLink, i: number, disabled: boolean, navigate: NavigateFunction) {
    return (
        <ListItemButton key={i} onClick={() => navigate(link.link)} disabled={disabled}>
            <ListItemIcon>
                {link.icon}
            </ListItemIcon>
